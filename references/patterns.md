...
- Importance claims that do not explain a consequence.
...
- Emoji or bold used as a substitute for hierarchy.
- A header for every two sentences.
- Bullets that would read better as one paragraph.
- Title Case everywhere.

## Voice erasure

- Replacing simple words with professional-sounding ones.
- Removing honest uncertainty that the writer meant.
